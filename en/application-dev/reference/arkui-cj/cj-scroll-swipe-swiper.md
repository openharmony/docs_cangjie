...
> - When the [visibility](./cj-universal-attribute-visibility.md#func-visibilityvisibility) attribute is set to Visibility.None or Visibility.Hidden, the corresponding child component is not displayed but still occupies space within the viewport.
