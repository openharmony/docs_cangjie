...
| follow | ?Bool | Yes | - | **Named parameter.** Used only in if paradigms to mark whether components always present in the component tree should follow the shared animation.<br>Initial value: false. |
