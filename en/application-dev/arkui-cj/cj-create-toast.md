...
Before showing a **TOP_MOST** Toast, a full-screen sub-window (matching the main window size on the device) is created. The Toast's layout position is calculated and displayed within this sub-window. Key differences between the modes are:  
