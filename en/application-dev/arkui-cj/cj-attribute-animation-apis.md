...
In the [animateTo](../reference/arkui-cj/cj-apis-uicontext-uicontext.md#func-animatetoanimateparam-voidcallback) interface parameters, `value` specifies an [AnimateParam object](../reference/arkui-cj/cj-common-types.md#class-animateparam) (including duration, [Curve](../reference/arkui-cj/cj-common-types.md#enum-curve), etc.), and `event` is the closure function for the animation. Property animations generated by variable changes within the closure will follow the same animation parameters.
