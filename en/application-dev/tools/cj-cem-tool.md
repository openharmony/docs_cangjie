...
Before using this tool, developers need to obtain the [HDC tool](https://gitcode.com/openharmony/docs/blob/master/en/application-dev/dfx/hdc.md) and execute the `hdc shell` command.
