...
Based on the [File Picker (startAbility)](../application-models/cj-file-processing-apps-startup.md) sharing method, applications can share individual files. The receiving application can open the URI using [ohos.file_fs's open](../reference/CoreFileKit/cj-apis-file_fs.md#static-func-openstring-int64) and perform read/write operations.

## Shareable Directories for Applications
...
| /data/storage/el2/distributedfiles   |  Application el2 encrypted-level distributed data fusion directory with account |
