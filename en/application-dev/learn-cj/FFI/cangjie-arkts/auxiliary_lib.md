...
For instance, the following shows the declaration of the `pick` method in the ArkTS [Camera Picker](https://gitcode.com/openharmony/docs/blob/master/en/application-dev/reference/apis-camera-kit/js-apis-cameraPicker.md) module, where the first parameter type is `common.Context`.
