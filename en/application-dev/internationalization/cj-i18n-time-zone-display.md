...
For detailed usage and instructions of the API, refer to the [getDisplayName](../reference/LocalizationKit/cj-apis-i18n.md#func-getdisplaynamestring) API documentation.  
