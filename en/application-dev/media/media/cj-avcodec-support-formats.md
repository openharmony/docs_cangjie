...
Currently supported decoding capabilities are as follows:

| Hardware Video Decoding Types | Software Video Decoding Types |
| ----------------------------- | ----------------------------- |
| AVC(H.264), HEVC(H.265)<!--RP14--><!--RP14End--> | MPEG2, MPEG4, H.263, AVC(H.264)<!--RP12--><!--RP12End--> |

### Video Encoding

Currently supported encoding capabilities are as follows:
...
Supported demuxing formats are as follows:
...
Currently supported muxing capabilities are as follows:
