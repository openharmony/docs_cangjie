...
> *2. 文档一级标题中的xxx为模块名，与API参考title保持一致。*
> *3. 错误码文档的命名规则：统一前缀，命名格式为cj-errorcode-xxx.md。*
> *4. 对于只有通用错误码的Kit，不需要提供错误码页面。*
...
> **说明：**
>
> 以下仅介绍本模块特有错误码，通用错误码请参考[通用错误码说明文档](../../application-dev/reference/cj-errorcode-universal.md)。
...
>
> *3.对系统或业务有影响的操作，在操作前以“注意”或“警告”形式提供警示信息。具体提示要求，请参见“风格指南”中的“提示与说明”：<https://gitcode.com/openharmony/docs/blob/master/zh-cn/contribute/style-guide/style-guide-content-elements.md>*
