...
场景1：异常处理中未主动退出，应用崩溃后不退出。例如采用[errorManger.on](../../../zh-cn/application-dev/reference/AbilityKit/cj-apis-app-ability-error_manager.md#static-func-onErrorManagerEvent-errorobserver)捕获CjError，或主动注册NativeCrash信号处理函数但未退出。
