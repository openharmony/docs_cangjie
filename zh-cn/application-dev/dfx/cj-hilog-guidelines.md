...
HiLog中定义了DEBUG、INFO、Warn、ERROR、FATAL五种日志级别，并提供了对应的方法输出不同级别的日志，接口如下表所示，具体说明可查阅[API参考文档](../../../zh-cn/application-dev/reference/PerformanceAnalysisKit/cj-apis-hilog.md)。
...
- **level**：用于指定日志级别。取值见[LogLevel](../../../zh-cn/application-dev/reference/PerformanceAnalysisKit/cj-apis-hilog.md#enum-loglevel)。
