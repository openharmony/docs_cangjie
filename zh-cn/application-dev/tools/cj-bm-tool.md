...
3. 根据查询返回结果，检查[模块级build-profile.json5](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-hvigor-build-profile)文件中的<!--RP01-->[“abiFilters”参数](https://gitcode.com/openharmony/docs/blob/master/zh-cn/application-dev/napi/ohos-abi.md#在编译架构中指定abi)<!--RP01End-->中的配置，规则如下：
