...
| [icon](#icon标签) | 标识[应用的图标](../../application-models/cj-application-component-configuration-stage.md#图标和标签配置)，取值为图标资源文件的索引。 | 字符串 | 该标签不可缺省。 |
...
此标签标识[应用的图标](../../application-models/cj-application-component-configuration-stage.md#图标和标签配置)和对分层图标配置文件的索引。
