...
> **说明：**
>
> 仅应用需要克隆、备份或同步用户公共目录的图片、视频类文件时，可申请ohos.permission.READ_IMAGEVIDEO、ohos.permission.WRITE_IMAGEVIDEO权限来读写音频文件，申请方式请参见<!--RP1-->[申请受控权限](../../security/AccessToken/cj-declare-permissions-in-acl.md)。<!--RP1End-->
