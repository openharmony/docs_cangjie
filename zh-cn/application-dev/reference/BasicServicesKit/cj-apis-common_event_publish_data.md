...
|parameters|HashMap\<String, [CommonEventValueType](cj-apis-value_type.md#enum-commoneventvaluetype)>|否|HashMap<String, CommonEventValueType>()| **命名参数。** 表示发布方传递的公共事件的附加信息。|
