...
- [CommonMethod](./cj-ui-framework.md#interface-commonmethodt)\<T>
...
|参数名|类型|必填|默认值|说明|
|:---|:---|:---|:---|:---|
|barState|?[BarState](./cj-common-types.md#enum-barstate)|是|-|滚动条状态。|
...
|参数名|类型|必填|默认值|说明|
|:---|:---|:---|:---|:---|
|color|?[ResourceColor](./cj-common-types.md#interface-resourcecolor)|是|-|滚动条颜色。|
...
|参数名|类型|必填|默认值|说明|
|:---|:---|:---|:---|:---|
|value|?[Length](./cj-common-types.md#interface-length)|是|-|滚动条宽度。|
...
|参数名|类型|必填|默认值|说明|
|:---|:---|:---|:---|:---|
|value|?[AppResource](../LocalizationKit/cj-apis-resource.md#class-appresource)|是|-|摩擦系数。|
...
|:---|:---|:---|:---|:---|
|enabled|Option\<Bool>|是|-|是否启用边缘淡出效果。|
|options|?[FadingEdgeOptions](#class-fadingedgeoptions)|是|-|边缘淡出选项。初始值：FadingEdgeOptions()。|
...
|参数名|类型|必填|默认值|说明|
|:---|:---|:---|:---|:---|
|clip|?[ContentClipMode](#enum-contentclipmode)|是|-|内容裁剪模式。|
...
|参数名|类型|必填|默认值|说明|
|:---|:---|:---|:---|:---|
|clip|?[RectShape](./cj-apis-shape.md#class-rectshape)|是|-|内容裁剪形状。|
...
|参数名|类型|必填|默认值|说明|
|:---|:---|:---|:---|:---|
|handler|Option\<(Float64, [ScrollState](./cj-common-types.md#enum-scrollstate), [ScrollSource](./cj-common-types.md#enum-scrollsource)) -> [ScrollResult](#class-scrollresult)>|是|-|滚动前触发的回调函数。|
...
|参数名|类型|必填|默认值|说明|
|:---|:---|:---|:---|:---|
|handler|Option\<(Float64, [ScrollState](./cj-common-types.md#enum-scrollstate), [ScrollSource](./cj-common-types.md#enum-scrollsource)) -> Unit>|是|-|滚动前触发的回调函数。|
...
|参数名|类型|必填|默认值|说明|
|:---|:---|:---|:---|:---|
|handler|?[OnScrollCallBack](#type-onscrollcallback)|是|-|滚动时触发的回调函数。初始值：{ _, _ => }。|

### class ScrollableCommonMethodComponent

```cangjie
public abstract class ScrollableCommonMethodComponent<T> {}
```
...
|参数名|类型|必填|默认值|说明|
|:---|:---|:---|:---|:---|
|barState|?[BarState](./cj-common-types.md#enum-barstate)|是|-|滚动条状态。初始值：BarState.Auto。|
...
|参数名|类型|必填|默认值|说明|
|:---|:---|:---|:---|:---|
|value|?[Length](./cj-common-types.md#interface-length)|是|-|滚动条宽度。初始值：4.vp。|
