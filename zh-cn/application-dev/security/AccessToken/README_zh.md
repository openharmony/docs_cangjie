...
- [访问控制概述](./cj-access-token-overview.md)
- 应用权限管控
    - [应用权限管控概述](./cj-app-permission-mgmt-overview.md)
    - 申请应用权限
        - [选择申请权限的方式](./cj-determine-application-mode.md)
    ...
    - [应用权限列表](./cj-app-permissions.md)
        ...
        - [受限开放权限](./cj-restricted-permissions.md)
        <!--Del-->
        - [可ACL申请的系统应用可用权限（系统授权）](./cj-permissions-for-system-apps.md)
        - [不可ACL申请的系统应用可用权限（系统授权）](./cj-permissions-for-system-apps-no-acl.md)
