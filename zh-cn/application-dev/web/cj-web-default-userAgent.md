...
> - 当前通过User-Agent中是否含有"Mobile"字段来判断是否开启前端HTML页面中meta标签的viewport属性。当User-Agent中不含有"Mobile"字段时，meta标签中viewport属性默认关闭，此时可通过显性设置[metaViewport](../../../zh-cn/application-dev/reference/arkui-cj/cj-web-web.md#func-metaviewportbool)属性为true覆盖关闭状态。
