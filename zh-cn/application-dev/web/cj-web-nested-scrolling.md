...
内嵌在可滚动容器（[Scroll](../../../zh-cn/application-dev/reference/arkui-cj/cj-scroll-swipe-scroll.md)、[List](../../../zh-cn/application-dev/reference/arkui-cj/cj-scroll-swipe-list.md)中的Web组件，接收到滑动手势事件，需要对接ArkUI框架的[NestedScrollMode](../../../zh-cn/application-dev/reference/arkui-cj/cj-common-types.md#enum-nestedscrollmode)枚举类型，使得Web组件可以嵌套ArkUI可滚动容器，进行嵌套滚动。开发者可以在Web组件创建时，使用[nestedScroll](../../../zh-cn/application-dev/reference/arkui-cj/cj-web-web.md#func-nestedscrollnestedscrollmode-nestedscrollmode)属性接口指定默认的嵌套滚动模式，也允许在过程中动态改变嵌套滚动的模式。

nestedScroll有两个入参，分别为scrollForward和scrollBackward，均为[NestedScrollMode](../../../zh-cn/application-dev/reference/arkui-cj/cj-common-types.md#enum-nestedscrollmode)枚举类型。
...
> **说明：**
>
> - 支持嵌套滚动的容器：[Grid](../../../zh-cn/application-dev/reference/arkui-cj/cj-scroll-swipe-grid.md)、[List](../../../zh-cn/application-dev/reference/arkui-cj/cj-scroll-swipe-list.md)、[Scroll](../../../zh-cn/application-dev/reference/arkui-cj/cj-scroll-swipe-scroll.md)、[Swiper](../../../zh-cn/application-dev/reference/arkui-cj/cj-scroll-swipe-swiper.md)、[Tabs](../../../zh-cn/application-dev/reference/arkui-cj/cj-navigation-switching-tabs.md)、[Refresh](../../../zh-cn/application-dev/reference/arkui-cj/cj-scroll-swipe-refresh.md)、[bindSheet](../../../zh-cn/application-dev/reference/arkui-cj/cj-animation-transition.md)。
