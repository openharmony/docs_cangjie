...
- 组件区域（蓝色方块）：组件区域表示组件的大小，[width](../reference/arkui-cj/cj-universal-attribute-size.md#func-widthoptionlength)、[height](../reference/arkui-cj/cj-universal-attribute-size.md#func-heightoptionlength)属性用于设置组件区域的大小。
