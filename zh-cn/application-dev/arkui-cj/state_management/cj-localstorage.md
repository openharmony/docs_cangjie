...
LocalStorage还提供了API接口，可以让开发者通过接口在自定义组件外手动触发Storage对应key的增删改查，建议配合[LocalStorage API文档](../../../../zh-cn/application-dev/reference/arkui-cj/cj-state-rendering-appstatemanagement.md#class-localstorage)阅读。
