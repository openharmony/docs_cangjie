...
Button是按钮组件，通常用于响应用户的点击操作，其类型包括胶囊按钮、圆形按钮、普通按钮。Button做为容器使用时可以通过添加子组件实现包含文字、图片等元素的按钮。具体用法请参见[Button](../../../zh-cn/application-dev/reference/arkui-cj/cj-button-picker-button.md)。

## 创建按钮

Button通过调用接口来创建，接口调用有以下两种形式：

- 通过label和[ButtonOptions](../../../zh-cn/application-dev/reference/arkui-cj/cj-button-picker-button.md#class-buttonoptions)创建不包含子组件的按钮。以ButtonOptions中的shape和stateEffect为例。
...
- 通过[ButtonOptions](../../../zh-cn/application-dev/reference/arkui-cj/cj-button-picker-button.md#class-buttonoptions)创建包含子组件的按钮。以ButtonOptions中的shape和stateEffect为例。
...
- 普通按钮。
  ...
  此类型的按钮默认圆角为0，支持通过[borderRadius](../../../zh-cn/application-dev/reference/arkui-cj/cj-common-types.md#class-borderradiuses)属性重新设置圆角。
...
- 设置边框弧度。
  ...
  使用通用属性来自定义按钮样式。例如通过[borderRadius](../../../zh-cn/application-dev/reference/arkui-cj/cj-common-types.md#class-borderradiuses)属性设置按钮的边框弧度。
...
- 设置背景颜色。
  ...
  添加[backgroundColor](../../../zh-cn/application-dev/reference/arkui-cj/cj-universal-attribute-background.md#func-backgroundcolorresourcecolor)属性设置按钮的背景颜色。
...
Button组件通常用于触发某些操作，可以绑定[onClick](../../../zh-cn/application-dev/reference/arkui-cj/cj-universal-event-click.md#func-onclickclickevent---unit)事件来响应点击操作后的自定义行为。
